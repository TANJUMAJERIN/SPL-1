...
string SHA(string msg)
{
    ...
    {
        binary_str.append(decimal_to_binary(int(msg[i])));
    }
...
int main()
{
    std::ifstream file("malware2.exe", std::ios::binary);
    ...
    if (file) {
        ...
        std::string hash = SHA(fileContent);
...
//mal1- bb58f861395064fd24f611c4fdcfaa78565c0e8ac8b824353e0a7b81888d537d
// mal1 virustotal-bb58f861395064fd24f611c4fdcfaa78565c0e8ac8b824353e0a7b81888d537d
//mal2 37fd3a6ec7af1c26762c41fa65314ed61e1ca9d0ebbfb8161d9b6a3bcb57f19e
//mal2virus-37fd3a6ec7af1c26762c41fa65314ed61e1ca9d0ebbfb8161d9b6a3bcb57f19e
