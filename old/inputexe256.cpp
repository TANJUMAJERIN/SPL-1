...
string SHA(string msg)
{
    ...
    cout<<"length of bin string of main str: "<<binary_str.size()<<endl;
    ...
    cout<<endl<<"length of bin string after padd: "<<binary_str.size()<<endl;
...
std::ifstream file("demo_exe_file.exe", std::ios::binary);
